...
int main(int argc, char *argv[]){
  ...
  ifstream mid_result1("Result/IntermediateRes1", ios::binary);
  ifstream mid_result2("Result/IntermediateRes2", ios::binary);
  ifstream mid_result3("Result/IntermediateRes3", ios::binary);
  Ciphertext temp1;
  ...
  if(n_query==1){
    ...
    int64_t index = (index_row_x * row_size + index_col_x) * TABLE_SIZE * TABLE_SIZE
                     + (index_row_y * row_size + index_col_y) * TABLE_SIZE
