...
int main(int argc, char const *argv[]) {
  ...
  cout << "Evaluating polynomial -0.00826 * x^4 - 0.00002634 * x^3 + 0.2213 * x^2 + 0.5001 * x + 0.01076 ..." << endl;
  double coeff4 = -0.00826;
  double coeff3 = -0.00002634;
  double coeff2 = 0.2213;
  double coeff1 = 0.5001;
  double coeff0 = 0.01076;
  ...
  cout << "Compute - 0.041 * x^4 + 0.3729 * x^2 + 0.5 * x." << endl;
  ...
  cout << "    + Scale of -0.00826 * x^4 - 0.00002634 * x^3 + 0.2213 * x^2 + 0.5001 * x before rescale: " << log2(encrypted_result.scale()) << " bits" << endl;
  evaluator.rescale_to_next_inplace(encrypted_result);
  cout << "    + Scale of -0.00826 * x^4 - 0.00002634 * x^3 + 0.2213 * x^2 + 0.5001 * x after rescale: " << log2(encrypted_result.scale()) << " bits" << endl;
  ...
  cout << "    + Exact scale in 0.01076: " << ct_coeff0.scale() << endl;
